                ...
                <div className="container">
                    <div className="tf-row-layout">
                        <div className="tf-layout-content">
                            ...
                            <div className="box-p">
                                <p>This policy sets out how we handle your personal information if you’re a Nulivo user or visitor to our Site.</p>
                                <p>In this document, Nulivo Market will sometimes be referred to as “we”.</p>
                                <p>This Privacy Notice is designed to help you understand everything you need to know about the what, why and how’s of our data gathering and processing operations, and what your legal rights are as an individual.</p>
                                <p>We hope you’ll take some time to read this document; we’ve tried to keep it all as simple as possible and we will keep you informed if there are any changes to the way we process your personal data in the future, before making them.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">1. How we collect personal information</div>
                                <p>We collect your personal information when you provide it to us when you complete buy on our Site, subscribe to a newsletter, email list, submit feedback, fill out a survey, or send us a communication</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">2. How We Use Your Information</div>
                                <p>We use the Personal Information you submit or that we collect to operate, maintain, and provide to you the features and functionality of the Service. We use your information in order to</p>
                                <ul className="box-list">
                                    <li>provide you with the Service under our agreement with you.</li>
                                    <li>where we have a legitimate interest in doing so to optimize the Service we offer and to let you know about our other products, services, and promotions.</li>
                                </ul>
                                <p>By providing us with your email address you acknowledge we may use the email address to send you Service-related notices, including any notices required by law, in lieu of communication by postal mail. You also acknowledge that we may send you notifications of activity on the Service to the email address you give us, in accordance with any applicable privacy settings. We may use your email address to send you other messages, such as newsletters, changes to features of the Service, or special offers.</p>
                                <p>We may use certain information about you and/or your User Content internally for purposes such as analyzing how the Service is used, diagnosing service or technical problems, maintaining security, and personalizing content.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">3. How We Share Your Information </div>
                                <p>Personal Information. We will not rent or sell your Personal Information to others. We may share your Personal Information with third parties (payment processors, customer support providers) for the purpose of providing the Service to you. If we do this, such third parties’ will be contractually bound to safeguard your Personal Information. We may store Personal Information in locations outside of our direct control (for instance, on servers or databases co-located with hosting providers) on the basis of an agreement to safeguard your information.</p>
                                <p>Except as otherwise described in this Privacy Policy, we will not disclose Personal Information to any third party unless required to do so by law or subpoena or if we believe that such action is necessary to:</p>
                                <ul className="box-list">
                                    <li>support legitimate interests, such as sharing Personal Information with payment processors and third parties who provide fraud detection services;</li>
                                    <li>to exercise or protect the rights, property, or personal safety of Nulivo Market;</li>
                                </ul>
                            </div>
                            <div className="box-p">
                                <div className="h9">4. How we keep your personal information secure </div>
                                <p>We store personal information on secure servers that are managed by us and our service providers, Personal information that we store or transmit is protected by security and access controls, including username and password authentication, two-factor authentication, and data encryption where appropriate.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">5. Cookies and web analytics </div>
                            ...
                            <div className="box-p">
                                <div className="h9">7. Links to Other Sites </div>
                                <p>Our Service may contain links to other sites. If you click on a third-party link, you will be directed to that site. Note that these external sites are not operated by us. Therefore, we strongly advise you to review the Privacy Policy of these websites. We have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">8. Changes to This Privacy Policy </div>
