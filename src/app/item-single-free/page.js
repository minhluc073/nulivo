                        ...
                        <Tab.Content>
                           <Tab.Pane eventKey="details">
                                <div className="wrap-single-detail">
                                    <div className="box">
                                        <div className="h9 text_black-5">Product Management Tools PowerPoint Template</div>
                                        <p className="text_black-1">Product Management Tools PowerPoint Template is a modern template that you can download and use for any type of business presentation, The template contains 40 unique slides designed by professionals that you can easily edit and fill out with your personal content, All objects are vectors objects, and they are fully editable, all icons used are smart object and vector which means you can easily change their size and colors to any size you want without losing resolution.</p>
                                    </div>
                                    <div className="box">
                                        ...
                                        <ul>
                                            ...
                                            <li>Just One Click to change the colors and auto recolored</li>
                                        ...
                                        <div className="box">
                                                ...
                                                <div className="content-right">
                                                    <div className="info">
                                                        <div className="box-author">
                                                            <div className="h9 name">Annette Black</div>
                                                            <span className="tag author">Author</span>
                                                        </div>
                                                        <span className="date-time">Nov 9, 2023 at 5:20 p.m</span>
                                                    </div>
                                                    <p className="cmt-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis ultrices metus, at egestas orci. Aenean vitae feugiat metus. Fusce dictum lectus sit amet tempor cursus. Etiam vel bibendum tortor</p>
                                            ...
                                            <div className="comment-item reply">
                                                ...
                                                <div className="content-right">
                                                    <div className="info">
                                                        <div className="box-author">
                                                            <div className="h9 name">Darrell Steward</div>
                                        ...
                                        <div className="box">
                                            <div className="comment-item">
                                                ...
                                                <div className="content-right">
                                                    <div className="info">
                                                        <div className="box-author">
                                                            <div className="h9 name">Cameron Williamson</div>
                                                        </div>
                                                        <span className="date-time">Nov 9, 2023 at 5:20 p.m</span>
                                                    </div>
                                                    <p className="cmt-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis ultrices metus, at egestas orci. Aenean vitae feugiat metus. Fusce dictum lectus sit amet tempor cursus. Etiam vel bibendum tortor</p>
                           ...
                           <Tab.Pane eventKey="report">
                                <form className="wrap-single-report">
                                    ...
                                    <div className="box">
                                        <div className="title-font fw-semibold">Report Category</div>
                                        <Select
                ...
                <div className="single-wrap-creator">
                    ...
                    <div className="creator-item">
						<div className="archive-top">
							<Link href="/user-profile" className="box-profile">
								<div className="avatar-check">
									<div className="avatar avt-70 round">
										<Image src="/images/avatar/avt-2.jpg" width={70} height={70} alt="avatar"/>
									</div>
                            ...
                            <Link href="/user-profile" className="tf-btn btn-sm">Follow</Link>
						</div>
						<div className="archive-bottom">
							<div className="banner-img">
								<Link href="/user-profile" className="image">
									<Image src="/images/banner/creator-1.jpg" width={154} height={95} alt="img-creator"/>
								</Link>
								<Link href="/user-profile" className="image">
									<Image src="/images/banner/creator-2.jpg" width={154} height={95} alt="img-creator"/>
								</Link>
								<Link href="/user-profile" className="image">
									<Image src="/images/banner/creator-3.jpg" width={154} height={95} alt="img-creator"/>
								</Link>
                                <Link href="/user-profile" className="image">
									<Image src="/images/banner/creator-4.jpg" width={154} height={95} alt="img-creator"/>
								</Link>
							</div>
