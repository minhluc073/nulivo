                                    ...
                                    <tr key={item?.id} className="item">
                                        ...
                                        <td className="list-info">
                                            ...
                                            <div className="item mt-12">
                                                ...
                                                <span className="d-block mt-2 text_primary">{item?.licence}</span>
                                            </div>
                                            <div className="item mt-12">
                                                <span className="text-6">Author</span>
                                                <span className="d-block mt-2 text_primary">{item?.author}</span>
                                            </div>
                                        </td>
                                        <td>{item?.price}</td>
                                        <td><span className="box-icon w_50 invoice"><i className="icon icon-invoice"></i></span></td>
                                        <td className="list-action">
                                            <Link href="#" className="mb-10 tf-btn width-1 btn-icon style-2"><span className="text">Download</span><i className="icon icon-download-2"></i></Link>
                                            <Link href="#" className="mb-10 tf-btn width-1 btn-line-primary">Refund</Link>
