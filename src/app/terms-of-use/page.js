                ...
                <div className="container">
                    <div className="tf-row-layout">
                        <div className="tf-layout-content">
                            ...
                            <div className="box-p">
                                <p>Welcome to Nulivo Market, a website and online market. This page explains the terms by which you may use our online and/or mobile services and website, or in connection with the Service. </p>
                                <p>These Terms apply to all visitors, users, sellers, buyers and others who access the Service (“User(s),” or “you,” or “your”) by creating an account and checking the “I agree” box or accessing or using the Service, you</p>
                                <p>(1) Agree that you have read, understood, and agree to be bound by the terms and conditions of these Terms of Service, including the License Terms (“Terms”), which constitute a binding agreement between us.</p>
                                <p>(2) Also that you have read and acknowledged the collection and use of your information as set forth in our privacy policy.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">1. Use of Our products</div>
                                <p>Nulivo Market provides a marketplace where Users can buy and sell digital assets and socialize around the content (e.g. make comments and participate in Discussions). Our Service allows for a buyer (“Buyer”) to purchase Assets from professional designers on Nulivo Market</p>
                                <p>The products of Nulivo are copyright protected by trademark and competition law, the customer is not entitled to receive the products in a manner other than via download (e.g. by mail) or a different form (e.g. in a different file format or on physical media such as CD-ROM).</p>
                                <p>The website of Nulivo Market (www.nulivo.com) and the offered products provide a bid to conclude a sales contract. When the customer places an order in the online shop of Nulivo Market, Nulivo Market sends an automatically generated email that confirms the receipt of the order and the separately listed details of the purchase (order confirmation).</p>
                                <p>The contract between the customer and Nulivo Market is formed when Nulivo Market accepts the offer of the customer by providing the ordered product by sending a download link. Depending on the selected payment method this order confirmation can arrive at the same time as the above-mentioned order confirmation. The contract covers only the provision of these products for download and the granting of rights to use these products according to the license terms</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">2. Nulivo Market Accounts</div>
                                <p>Your Nulivo Market account gives you access to the services and features that we may establish and maintain from time to time and in our sole discretion.<br/>
                                We may maintain different types of accounts for different types of Users. By connecting to Nulivo Market with a third-party service, you give us permission to access and use your information from that service as permitted by that service, and to store your login credentials for that service. You will be responsible for tracking all activity for your account, and you agree to the following:</p>
                                ...
                                <p>Nulivo Market reserves the right to monitor downloads and user activity to ensure compliance with the terms of these Terms and the applicable License Agreement, which it may update from time to time.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">3. Resolution Process for Transactions</div>
                                <p>All parties share the responsibility for making sure that purchases facilitated by our Service are satisfactory and hassle-free. Our Service hosts the resolution process for transactions when Buyers claim that their Asset was not received, or the Asset they received was different from what was described in the product listing. We may take a more active role in ensuring transaction problems are resolved; however, you understand that we are not obligated to do so. You agree to permit us to make a final decision, in our sole discretion, on any disputes. We reserve the right to fix any processing errors we discover. We will correct any processing errors by debiting or crediting the payment method used. Should you file a chargeback or dispute on a purchase you have made on Nulivo Market, we reserve the right to close your account without notice.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">4. Payment Information</div>
                            ...
                            <div className="box-p">
                                <div className="h9">5. Usage Rights</div>
                                <p>Nulivo market offers two types of license is a Regular license and Extended license. Every file downloaded from Nulivo Market comes with a Standard License. Click the following link for the Usage Rights and License details of Nulivo Market Licenses</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">6. Children’s Privacy</div>
                                <p>Our Services do not address anyone under the age of 16. We do not knowingly collect personal identifiable information from children under 16. In the case we discover that a child under 16 has provided us with personal information, we immediately delete this from our servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact us so that we will be able to do the necessary actions.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">7. Refund Policy</div>
                                <p>Our refund policy was made to be transparent so your experience is as smooth as possible and gives you a “fair go” by using a baseline standard. Check out the following link for the detailed information about Nulivo Market’s refund policy</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">Contact Us</div>
                        ...
                        <div className="tf-layout-sidebar"><SidebarPage/></div>
                    </div>
                </div>
            </div>
        </Layout>
