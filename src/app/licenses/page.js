...
export default function PrivacyPolicy() {
  return (
    <>
        <Layout>
            <PageTitle title="Nulivo Market Licenses" />
                ...
                <div className="container">
                    <div className="tf-row-layout">
                        <div className="tf-layout-content">
                            <h5 className="title">Nulivo Market Licenses</h5>
                            <div className="box-p">
                                <p>Nulivo market offers two types of licenses is a Regular license and an Extended license, When you purchase an item from our marketplace, you’re purchasing a license to use that item.</p>
                                <p>What can and cannot be done with all resources under the Nulivo Market?</p>
                            </div>
                            <div className="box-p">
                                <div className="h9 title-license">License 1: Regular license</div>
                                <p className="text">Our Regular license allows you to create personal and commercial use products.</p>
                                <div className="box-child">
                                    <div className="sub-title">Acceptable Use:</div>
                                    <ul className="box-list">
                                        <li>Unlimited End Products for yourself</li>
                                        <li>Create 20 End Products for your clients, and you can transfer that End Product to your clients for any fee</li>
                                        <li>Create End Products for Sale where lifetime sales of the End Product for Sale do not exceed 20 units</li>
                                    </ul>
                                </div>
                                <div className="box-child">
                                    <div className="sub-title">Non-acceptable Use:</div>
                                    <ul className="box-list">
                                        <li>Distributing files downloaded/purchased from us in any manner, including selling, giving away for free</li>
                                        <li>Allowing more than one user to use items downloaded/purchased from us to make projects for personal or commercial use</li>
                                        <li>Sell the End Product, except for 20 clients. (If you or your client want to Sell the End Product more than 20 times, you will need the Extended License.)</li>
                                        <li>Resell as stock with source files on other marketplaces.</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="box-p">
                                <div className="h9 title-license">License 2: Extended license</div>
                                <p className="text">Our Extended license allows unlimited users within your company/household to create a commercial unlimited sales end product</p>
                                <div className="box-child">
                                    <div className="sub-title">Acceptable Use:</div>
                                    <ul className="box-list">
                                        <li>Unlimited users working on different projects for personal or commercial use within one organization or household</li>
                                        <li>Unlimited End Products for yourself or for unlimited clients and the End Products may be sold</li>
                                        <li>Unlimited End Products for yourself or for unlimited clients, and you can transfer that End Product to your clients for any fee</li>
                                        <li>Create customizable physical or digital items using products downloaded/purchased from us</li>
                                    </ul>
                                </div>
                                <div className="box-child">
                                    <div className="sub-title">Non-acceptable Use:</div>
                            ...
                            <div className="box-p">
                                <div className="h9 title-license">Nulivo Market Free templates</div>
                                <p className="text">By downloading and using Nulivo Market Free templates, you agree to be bound by these terms of use.<br/>
                                If you disagree with these terms of use or any part of these terms of use, you must not use Nulivo Market Free templates.</p>
                                <div className="box-child">
                                    <div className="sub-title">You are allowed to:</div>
                                    <ul className="box-list">
                                        <li>Use Nulivo Market Free templates for personal or commercial projects or prints.</li>
                                        <li>Edit, and customize templates for your own needs.</li>
                                    </ul>
                                </div>
                                <div className="box-child">
                                    <div className="sub-title">You are not allowed to:</div>
                                    <ul className="box-list">
                                        <li>Republish or redistribute Nulivo Market Free templates, offline or online and even for free.</li>
                                        <li>You can’t Make these templates available on a website or social network for download</li>
                                    </ul>
                                </div>
                            </div>
