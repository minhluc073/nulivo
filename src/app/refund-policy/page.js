                ...
                <div className="container">
                    <div className="tf-row-layout">
                        <div className="tf-layout-content">
                            <h5 className="title">Refund Policy</h5>
                            <div className="box-p">
                                <p>We are so confident in our products that we offer a 30-day-money back guarantee. If you find our products are not compatible, corrupt or are missing on download we can refund you the price you paid.</p>
                                <p>As part of our refund policy, you must allow us sufficient time to remedy the problem. Most issues are resolved within 7 days and if we cannot resolve any issue within 7 days we will provide a full refund.</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">Before requesting a refund</div>
                                <p>Review our Refund Rules to check if you are eligible for a refund</p>
                            </div>
                            <div className="box-p">
                                <div className="h9">Nulivo Market Refund Rules</div>
                                <p>Here are the situations in which we give a refund on a product and related services you have purchased from Nulivo Market</p>
                                <ul className="box-list">
                                    <li>Each product has its own description below on product the page which demonstrating all product features and attributes. If it turns out the product is “not as described” you will be entitled to a refund.</li>
                                    <li>The Product doesn’t work the way it should – If a product doesn’t work the way it should, you are entitled to a refund.</li>
                                </ul>
                            </div>
                            <div className="box-p">
                                <div className="h9">Why a refund may not be given</div>
                                <p>If the product is materially similar to the description and preview and works the way it should, there is generally no obligation to provide a refund in situations like the following:</p>
                                <ul className="box-list">
                                    <li>You don’t want it after you’ve downloaded it.</li>
                                    <li>The product did not meet your expectations.</li>
